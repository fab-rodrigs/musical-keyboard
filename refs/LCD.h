...
#define DADOS_LCD    	P6OUT  	  //4 bits de dados do LCD no PORTD
...
#define CONTR_LCD 		P3OUT     //PORT com os terminais de controle do LCD (pino R/W em 0).
#define E    			3      //habilitação do LCD (enable)
#define RS   			2      //informar se o dado é uma instrução ou caractere
#define BkL             4      // BackLight
...
//#define pulso_enable()  __delay_cycles(1); set_bit(CONTR_LCD,E); __delay_cycles(1); clr_bit(CONTR_LCD,E); __delay_cycles(45);
